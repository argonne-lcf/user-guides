...
SambaNova provides examples of some well-known AI applications under the path: `/opt/sambaflow/apps/starters`, on a given SambaNova compute node. Make a copy of this to your home directory:
