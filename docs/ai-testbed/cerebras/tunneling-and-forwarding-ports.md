...
The Cerebras user nodes are accessed through two steps; tunneling and port forwarding need to be through a login node.
...
See also ALCF's [Jupyter Instructions](https://github.com/argonne-lcf/ThetaGPU-Docs/blob/master/doc_staging/jupyter.md).
