...
/home/arnoldw/R_2.10.0/venv_cerebras_pt/lib/python3.8/site-packages/pydantic/_internal/_gener
```
...
```bash
cd ~/R_2.10.0/modelzoo/src/cerebras/modelzoo/models/nlp/llama
...
```bash
cd ~/R_2.10.0/modelzoo/src/cerebras/modelzoo/models/nlp/esm2
...
Instructions for training (for 400 steps):
```bash
cd ~/R_2.10.0/modelzoo/src/cerebras/modelzoo/models/vision/vision_transformer
...
Instructions for training (for 400 steps):
```bash
cd ~/R_2.10.0/modelzoo/src/cerebras/modelzoo/models/vision/dit
