...
If an environment is made in ```~/R_2.2.1/```, it would be activated as follows:
```console
...
cd ~/R_2.2.1/modelzoo/src/cerebras/modelzoo/fc_mnist/pytorch
```
...
python run.py CSX --job_labels name=fc_mnist --params configs/params.yaml --num_csx=1 --mode train --model_dir $MODEL_DIR --mount_dirs /home/$(whoami)/ /software --python_paths /home/$(whoami)/R_2.2.1/modelzoo/src --compile_dir /$(whoami) |& tee mytest.log
```
