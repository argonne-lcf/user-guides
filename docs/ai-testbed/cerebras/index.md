...
The public Cerebras documentation is available [here](https://training-docs.cerebras.ai/rel-2.10.0/getting-started/overview).
...
/// caption
Figure: topology of CS-3 cluster ([source](https://training-docs.cerebras.ai/rel-2.10.0/concepts/cerebras-wafer-scale-cluster))
///
