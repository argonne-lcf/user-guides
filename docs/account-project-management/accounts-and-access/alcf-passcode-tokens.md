...
Upon receipt of CRYPTOCard token, contact [ALCF Support Desk](mailto:support at alcf.anl.gov) must verify identity and activate token. If this step is not performed the CRYPTOCard token will not be able to log on to the ALCF resource.

**ALCF Support Desk Info**
**Hours:** Monday-Friday 9 a.m. - 5 p.m. (Central time);
**Email:** [support at alcf.anl.gov](mailto:support at alcf.anl.gov)
