...
## More information
See the ==[Theta documentation](https://github.com/argonne-lcf/alcf-userguide/blob/main/docs/theta/performance-tools/darshan.md)== for more ALCF specific Darshan usage.  
