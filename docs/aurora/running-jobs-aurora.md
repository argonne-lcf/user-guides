...
| prod          | 1        | 7936    | 5 min    | 24 hrs   | Routing queue for tiny, small, medium, and large queues; <br/> **See table below for min/max limits**|
| prod-large    | 1920     | 7936    | 5 min    | 24 hrs   | Legacy routing queue for large jobs; See table below                                                 |
...
| backfill-large  | 1920     | 7936    | 5 min    | 24 hrs   | Low priority, negative project balance                                                           |
