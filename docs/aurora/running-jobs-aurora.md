...
| prod          | 1        | 6900*    | 5 min    | 24 hrs   | Routing queue for tiny, small, medium, and large queues; <br/> **See table below for min/max limits**|
| prod-large    | 1920     | 6900*    | 5 min    | 24 hrs   | Legacy routing queue for large jobs; See table below                                                 |
...
| large           | 1920     | 6900*    | 5 min    | 24 hrs   | stable max nodecount until new image is deployed across all the nodes                             |
...
| backfill-large  | 1920     | 6900*   | 5 min    | 24 hrs   | Low priority, negative project balance; stable max nodecount until new image is deployed across all the nodes |
