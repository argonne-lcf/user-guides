...
```
Refer to [getting started on Aurora]((docs/aurora/getting-started-on-aurora.md)) for additional information. In particular, you need to set the environment variables that provide access to the proxy host.
!!! note
