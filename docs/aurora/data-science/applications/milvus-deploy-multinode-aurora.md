...
The deployment scripts and configuration files for running Milvus on Aurora are available in the [VDB](https://github.com/argonne-lcf/VDB) repository. Clone the `aurora` branch to your home directory on Aurora:

```bash
git clone -b aurora https://github.com/argonne-lcf/VDB.git
cd VDB
```
