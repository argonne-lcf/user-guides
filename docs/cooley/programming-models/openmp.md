...
OpenMP support for CPUs on Cooley is provided through the GNU, Intel, and LLVM Clang compilers available on Cooley. Guidance on updating your environment to use one of these compilers is available [here](https://www.alcf.anl.gov/support-center/cooley/compiling-and-linking-cooley).
