...
It may be necessary to use single or double quotes around metacharacters to avoid having the shell prematurely expand them. For example, the following will not work:
```console linenums="1"
[HSI]/home/username-> get *.c
```

In contrast, the following quoted command will work:
```console linenums="1"
[HSI]/home/username-> get "*.c"
```

It will retrieve all files ending in `.c`.
...
This retrieves the file named `data file ; version 1`.
