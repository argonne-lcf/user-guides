...
| Queue Name      | Node Min                               | Node Max | Time Min | Time Max                                     | Notes                                  |
|-----------------|----------------------------------------|----------|----------|----------------------------------------------|----------------------------------------|
| small           | 10                                     | 24       | 5 min    | 6 hrs (3 hrs, from next maintanence window)  ||
| medium          | 25                                     | 49       | 5 min    | 12 hrs (6 hrs, next maintanence window)      ||
| large           | 50 (100, from next maintanence window) | 496      | 5 min    | 24 hrs                                       ||
| backfill-small  | 10                                     | 24       | 5 min    | 6 hrs (3 hrs, from next maintanence window)  | low priority, negative project balance |
| backfill-medium | 25                                     | 49       | 5 min    | 12 hrs (6 hrs, from next maintanence window) | low priority, negative project balance |
| backfill-large  | 50 (100, from next maintanence window) | 496      | 5 min    | 24 hrs                                       | low priority, negative project balance |
